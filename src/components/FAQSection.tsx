...
const FAQSection = () => {
  ...
  return (
    <section id="faq" aria-labelledby="faq-heading" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 id="faq-heading" className="text-3xl md:text-4xl font-bold text-foreground mb-4 flex items-center justify-center gap-2">
